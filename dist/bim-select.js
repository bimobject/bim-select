...
/***/ "./node_modules/css-loader/index.js?!./node_modules/less-loader/dist/cjs.js?!./src/bim-select.less":
/*!******************************************************************************************************************!*\
 ...
 *   as it's first parameter (which may be falsy if nothing is selected), it recieves the
 *   component $element itself as the 2nd parameter. Returning true makes it valid, false
 *   makes it invalid.
 * @example
 * Simple example
 *
 ...
 * ];
 * const isAdmin = false;
 * vm.validator = function(selectedItem, $element) {
 *     if (selectedItem) {
...
function BimSelectController($document, $element, $timeout, $scope, $attrs, bimSelectConfig) {
  ...
  function validateSelected() {
    var item = $ctrl.model.$modelValue && adaptItem($ctrl.model.$modelValue);
    var isValid = $ctrl.validator(item, $element);
...
var content = __webpack_require__(/*! !../node_modules/css-loader??ref--5-1!../node_modules/less-loader/dist/cjs.js??ref--5-2!./bim-select.less */ "./node_modules/css-loader/index.js?!./node_modules/less-loader/dist/cjs.js?!./src/bim-select.less");
